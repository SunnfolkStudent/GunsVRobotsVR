...
public partial class @XRIDefaultInputActions : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        },
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""141515dc-3a65-4f6c-a069-e6a65d8357f2"",
                    ""path"": ""<XRController>{RightHand}/Primary2DAxis"",
                    ""interactions"": ""Sector(directions=12,sweepBehavior=1),Sector(directions=2,sweepBehavior=2)"",
                    ""processors"": """",
                    ""groups"": ""Generic XR Controller"",
                ...
                {
                    ""name"": """",
                    ""id"": ""5c5593b0-d686-439e-9764-d45e9a7da364"",
                    ""path"": ""<XRController>{RightHand}/Primary2DAxis"",
                    ""interactions"": ""Sector(directions=12,sweepBehavior=1),Sector(directions=2,sweepBehavior=2)"",
                    ""processors"": """",
                    ""groups"": ""Generic XR Controller"",
        ...
        {
            ""name"": ""XR WeaponSystem"",
            ""id"": ""eeb6cdfc-d884-4b29-b12a-3b69aa244770"",
            ""actions"": [
                {
                    ""name"": ""FireButton"",
                    ""type"": ""Button"",
                    ""id"": ""0139c470-7ae8-4d5c-be49-f4252ec5ff4b"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""ReloadButton"",
                    ""type"": ""Button"",
                    ""id"": ""fca99f3f-e73b-42e8-a9a6-6b7ea8651f98"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""eb3b61f5-da52-42c2-898d-92c62804cbd5"",
                    ""path"": ""<XRController>{RightHand}/triggerPressed"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""36053f09-6a1f-4242-a560-49ada31dc3b2"",
                    ""path"": ""<Mouse>/leftButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""0b81c4c6-bc95-4a8a-bb41-7a12b0f06563"",
    ...
    ""controlSchemes"": [
        ...
        m_XRWeaponSystem_ReloadButton = m_XRWeaponSystem.FindAction("ReloadButton", throwIfNotFound: true);
    }
    ...
    // XR WeaponSystem
    private readonly InputActionMap m_XRWeaponSystem;
    private IXRWeaponSystemActions m_XRWeaponSystemActionsCallbackInterface;
    private readonly InputAction m_XRWeaponSystem_FireButton;
    private readonly InputAction m_XRWeaponSystem_ReloadButton;
    public struct XRWeaponSystemActions
    {
        private @XRIDefaultInputActions m_Wrapper;
        public XRWeaponSystemActions(@XRIDefaultInputActions wrapper) { m_Wrapper = wrapper; }
        public InputAction @FireButton => m_Wrapper.m_XRWeaponSystem_FireButton;
        public InputAction @ReloadButton => m_Wrapper.m_XRWeaponSystem_ReloadButton;
        public InputActionMap Get() { return m_Wrapper.m_XRWeaponSystem; }
        public void Enable() { Get().Enable(); }
        public void Disable() { Get().Disable(); }
        public bool enabled => Get().enabled;
        public static implicit operator InputActionMap(XRWeaponSystemActions set) { return set.Get(); }
        public void SetCallbacks(IXRWeaponSystemActions instance)
        {
            if (m_Wrapper.m_XRWeaponSystemActionsCallbackInterface != null)
            {
                @FireButton.started -= m_Wrapper.m_XRWeaponSystemActionsCallbackInterface.OnFireButton;
                @FireButton.performed -= m_Wrapper.m_XRWeaponSystemActionsCallbackInterface.OnFireButton;
                @FireButton.canceled -= m_Wrapper.m_XRWeaponSystemActionsCallbackInterface.OnFireButton;
                @ReloadButton.started -= m_Wrapper.m_XRWeaponSystemActionsCallbackInterface.OnReloadButton;
                @ReloadButton.performed -= m_Wrapper.m_XRWeaponSystemActionsCallbackInterface.OnReloadButton;
                @ReloadButton.canceled -= m_Wrapper.m_XRWeaponSystemActionsCallbackInterface.OnReloadButton;
            }
            m_Wrapper.m_XRWeaponSystemActionsCallbackInterface = instance;
            if (instance != null)
            {
    ...
    public XRWeaponSystemActions @XRWeaponSystem => new XRWeaponSystemActions(this);
